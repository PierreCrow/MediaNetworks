...
public class CameraSource {
    ...
    private CameraSource.FrameProcessingRunnable mFrameProcessor;
        ...
        synchronized(this.mCameraLock) {
            if (this.mCamera == null) {
                ...
                if (!parameters.isZoomSupported()) {
                    ...
                    int currentZoom = parameters.getZoom() + 1;
                    float newZoom;
                    if (scale > 1.0F) {
    ...
    public void takePicture(CameraSource.ShutterCallback shutter, CameraSource.PictureCallback jpeg) {
        synchronized(this.mCameraLock) {
            if (this.mCamera != null) {
                ...
                this.mCamera.takePicture(startCallback, (android.hardware.Camera.PictureCallback)null, (android.hardware.Camera.PictureCallback)null, doneCallback);
            }
    ...
    private static List<CameraSource.SizePair> generateValidPreviewSizeList(Camera camera) {
        Camera.Parameters parameters = camera.getParameters();
